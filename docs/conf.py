...
project = u'F5 Orchestration Templates for OpenStack Heat'
...
.. raw:: html
   ...
   <script type="text/javascript">
    ...
    if (window.location.hostname === rtd) {window.location.assign("http://" + home + "/products/templates/openstack-heat/liberty");}
   </script>
'''
...
htmlhelp_basename = 'F5OpenStackHeatdoc'
...
latex_documents = [
    (master_doc, 'F5OpenStackHeat.tex', u'F5 Orchestration Templates for OpenStack Heat Documentation',
...
man_pages = [
    (master_doc, 'f5openstackheat', u'F5 Orchestration Templates for OpenStack Heat Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'F5OpenStackHeat', u'F5 Orchestration Templates for OpenStack Heat Documentation',
     author, 'F5OpenStackHeat', 'One line description of project.',
     'Miscellaneous'),
]
